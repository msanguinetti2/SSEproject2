...
class Generic(Resource):
    ...
    def post(self, type):
        if type=="sav":
            ...
            threadSendPeer = threading.Thread(target=self.sendPostRequest, args=('192.168.1.24:5005', 'msg', 'hi'))
            threadSendPeer.start()
            threadSendOrch = threading.Thread(target=self.sendPostRequest, args=('192.168.1.24:5006', 'msg', 'generic4'))
